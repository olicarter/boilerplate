...
test('hamburger button is visible on mobile', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
  await expect(page.getByRole('button', { name: 'Open menu' })).toBeVisible();
});

test('nav links are hidden by default on mobile', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
  await expect(page.getByRole('link', { name: 'Delegations' })).not.toBeVisible();
});

test('hamburger opens the slide-in menu', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
...
test('close button hides the menu', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
  await page.getByRole('button', { name: 'Open menu' }).click();
...
test('overlay click closes the menu', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
  await page.getByRole('button', { name: 'Open menu' }).click();
...
test('navigating from the menu closes it', async ({ page, asAlice }) => {
  await page.goto('/orgs/ripple-test/proposals');
  await page.getByRole('button', { name: 'Open menu' }).click();
