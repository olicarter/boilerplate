...
- Name: tests/personal-filters.spec.ts >> "My proposals" filter is visible when logged in
- Location: e2e/tests/personal-filters.spec.ts:6:5
...
Locator: getByRole('button', { name: 'My proposals' })
Expected: visible
Timeout: 15000ms
    ...
    - generic [ref=e13]:
      - generic [ref=e14]:
        - link "Alice" [ref=e15] [cursor=pointer]:
          - /url: /orgs/ripple-test/users/c11ffabb-f9e2-4148-87e2-e5d6620ac4d1
