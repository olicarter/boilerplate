...
- Name: tests/comment-pin.spec.ts >> comment pinning >> author can pin a comment and it shows pinned indicator
- Location: e2e/tests/comment-pin.spec.ts:15:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Pin' }) resolved to 2 elements:
    ...
    - generic [ref=e13]:
      - generic [ref=e14]:
        - link "Alice" [ref=e15] [cursor=pointer]:
          - /url: /orgs/ripple-test/users/17928931-7725-4bf8-a7fa-d896c01e9e63
  ...
  - main [ref=e19]:
    - generic [ref=e20]:
      - link "← Proposals" [ref=e21] [cursor=pointer]:
        - /url: /orgs/ripple-test/proposals
      - generic [ref=e22]:
        - generic [ref=e23]: Pin2 Topic
        - generic [ref=e24]: open
      - generic [ref=e25]:
        - heading "Pin2 proposal" [level=1] [ref=e26]
      ...
      - generic [ref=e58]:
        ...
        - generic [ref=e60]:
          - link "Export CSV" [ref=e61] [cursor=pointer]:
            - /url: /api/proposals/9a30a9ba-16d9-45ec-b07d-d1cb74469dc8/tally/csv
      ...
      - generic [ref=e96]:
        ...
        - generic [ref=e99]:
          ...
          - generic [ref=e101]:
            ...
            - paragraph [ref=e112]: Key context comment
            - generic [ref=e113]:
